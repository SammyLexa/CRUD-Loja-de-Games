...
- [Front-End e outros Detalhes](https://github.com/SammyLexa/CRUD-Loja-de-Games-CuteUnicorn-FRONTEND)
...
O software é um CRUD, focado na venda de jogos eletrônicos e outros produtos desse nicho. Capaaz de Realizar todas funções CRUD(Criar, Consultar, Atualizar e 
Deletar).
Criado com o objetivo de aprimorar meus conhecimentos de Java, Spring, Banco de dados Relacional(MySQL), Insomnia para Testes.
